...
export default function ReactivoCard({
  ...
  return (
    <article className="rounded-2xl bg-white p-8 shadow-sm">
      ...
      <p className="font-semibold text-slate-800">Caso</p>
      ...
      {respondida && (
        <div className="mt-6 rounded-xl bg-slate-100 p-5">
          ...
          {reactivo.porQueNo && reactivo.porQueNo.length > 0 && (
            <div className="mt-5">
              <p className="font-semibold">
              ...
              <div className="mt-3 space-y-2">
                {reactivo.porQueNo.map((explicacion, index) => (
                  <p
                    key={index}
          ...
          {reactivo.bibliografia && (
            <p className="mt-2 text-sm text-slate-600">
              <strong>Bibliografía:</strong> {reactivo.bibliografia}
            </p>
          )}
        </div>
      )}
